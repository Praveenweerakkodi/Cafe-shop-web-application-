<?php 
    ...
    if (isset($_POST['login'])) {
        ...
        if ($select_admin->rowCount() > 0) {
            ...
            $_SESSION['login_success'] = 'Admin Login successfully'; // Set the session variable
...
<head>
    ...
    <title>gallery cafe admin panel - Login page</title>
</head>
<body>
        ...
        <section class="form-container" id="admin-login">
            <div class="title5">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <p>Did not have an account ? <a href="javascript:void(0);"  onclick="checkLogin('book')">Register Now</a></p>
