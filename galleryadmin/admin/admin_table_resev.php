<?php 
    ...
    if (isset($_POST['delete'])) {
        ...
        $verify_delete = $conn->prepare("SELECT * FROM `table_resev` WHERE id = ?");
        $verify_delete->execute([$delete_id]);

        if ($verify_delete->rowCount() > 0) {

            $delete_message = $conn->prepare("DELETE FROM `table_resev` WHERE id = ?");
...
<head>
    ...
    <title>gallery cafe admin panel - Table Reservation's page</title>
</head>
<body>
    ...
    <div class="banner-login">
        ...
        <div class="title2">
            <a href="dashboard.php">Dashboard</a><span> / Table Reservation's</span>
        </div>
        <section class="accounts">
            <h1 class="heading">Table Reservation's</h1>
            <div class="box-container">
                ...
                <div class="box">
                    ...
                    <p>Members- <span><?= $fetch_message['members']; ?></span></p>
                    <p>Date- <span><?= $fetch_message['date']; ?></span></p>
                    <p>Feedback- <span><?= $fetch_message['note']; ?></span></p>
