<?php 
    ...
    if (isset($_POST['delete'])) {
        ...
        if ($verify_delete->rowCount() > 0) {
            ...
            $delete_message = $conn->prepare("DELETE FROM `admin` WHERE id = ?");
...
<head>
    ...
    <title>gallery cafe admin panel - Registered Admin's page</title>
</head>
<body>
    ...
    <div class="banner-login">
        ...
        <div class="title2">
            <a href="dashboard.php">Dashboard</a><span> / Registered Admin's</span>
        </div>
        <section class="accounts">
            <h1 class="heading">Registered admin's</h1>
            <div class="box-container">
                ...
                <div class="box">
                    ...
                    <p>Admin email : <span><?= $fetch_users['email']; ?></span></p>
                    <form action="" method="post" class="flex-btn" >
                        ...
                        ('Delete this message')">Delete Admin</button>
                    </form>
                </div> 
                <?php           
                        }
