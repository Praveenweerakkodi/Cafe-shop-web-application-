<?php 
    ...
    if (isset($_POST['login'])) {
        ...
        if ($select_admin->rowCount() > 0) {
            ...
            $_SESSION['login_success'] = 'User Login successfully'; // Set the session variable
            header('location:after_user_login.php');
        } else {
...
<head>
    ...
    <title>gallery cafe user panel - Login page</title>
</head>
<body>
    ...
    <section class="form-container" id="admin-login">
            <div class="title5">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <p>Did not have an account ? <a href="user_register.php">Register now</a></p>
